module mem_manager (
    ...
    // DISPLAY 7 segmentos MMIO
    output logic        disp_en,
    output logic        disp_we,
    output logic [31:0] disp_wdata,
    ...
    always_comb begin
        ...
        if (addr < 32'h0001_0000) begin
            ...
            uart_we = mem_write;
            rdata   = uart_rdata;
        end else if (addr >= 32'h1000_0030 && addr < 32'h1000_0040) begin
            // DISPLAY 7 segmentos 0x1000_0030 - 0x1000_003F
            disp_en = mem_read | mem_write;
            disp_we = mem_write;
            rdata   = disp_rdata;
        end else begin
