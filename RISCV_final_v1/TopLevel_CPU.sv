...
//              Switches, Displays y UART mapeada en memoria
//========================================================
...
module TopLevel_CPU (
    ...
    // SeÃ±ales MMIO display
    logic        disp_en, disp_we;
    logic [31:0] disp_wdata, disp_rdata;
    ...
    // =====================
    // UART MMIO (perifÃ©rico mapeado en memoria)
    // =====================
    uart_mmio u_uart (
        .clk     (clk),
        .rst     (rst),
        .en      (uart_en),
        .we      (uart_we),
        .addr    (ALUResult),   // misma direcciÃ³n que ve mem_manager
        .wdata   (uart_wdata),
        .rdata   (uart_rdata),
        .uart_rx (uart_rx),
        .uart_tx (uart_tx)
   ...
   // Instancia DISPLAY MMIO
    display_mmio u_disp_mmio (
        .clk   (clk),
        .rst   (rst),
        .en    (disp_en),
        .we    (disp_we),
